		...
		<Section id="how-to-use">
			<div className="container">
				...
				<div className="relative">
					...
					>
						...
						<div className="relative z-1 max-w-68 ml-auto">
							<h4 className="mb-4">Smartest AI</h4>
				...
				<div className="relative z-1 grid gap-5 lg:grid-cols-2">
					<div
						className="relative min-h-156 border 
					...
					>
						...
						p-8 bg-linear-to-b from-n-8/0 to-n-8/90 lg:p-15"
						>
							<h4 className="mb-4">Photo editing</h4>
							<p className="body-2 mb-12 text-n-3">
					...
					<div className="p-4 bg-n-7 rounded-2xl overflow-hidden lg:min-h-184">
								...
								{brainwaveServicesIcons.map((item, index) => (
									<li
										...
										className={`rounded-2xl flex items-center justify-center
											${
												index === 2
													? "w-12 h-12 p-0.25 bg-conic md:w-18 md:h-18"
						...
						<div
							className="relative h-48 bg-n-8 rounded-xl
						overflow-hidden md:h-100"
						>
							<img
								src={service3}
								className="w-full h-full object-cover"
